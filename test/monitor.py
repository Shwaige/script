...
def  result():
   ...
   headers = {"Content-Type":"application/json","accessToken":"ec60e8f0-db81-45db-aa7d-b1364408b623","userId":"WuWenKe"}
   data_list = {"pageSize":50,"pageNum":1,"type":12,"sorts":[],"queries":[],"queryKey":""}
   response_list =requests.post(url=url_list,headers=headers,json=data_list).json()
   d = 425 + response_list["result"]["resultAmount"]
   print(d)
   params = request.args
